...
const WhyUsSection = () => {
  return (
    <section id="why-us" className="relative py-20 lg:py-32 overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-72 h-72 bg-primary/10 rounded-full blur-3xl opacity-30" />
      <div className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-secondary/10 rounded-full blur-3xl opacity-30" />
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="glass-card rounded-3xl p-8 h-full text-center hover-lift">
                {/* Icon */}
                <div className={`w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center transition-transform duration-300 group-hover:scale-105`}>
